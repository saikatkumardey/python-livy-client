...
class JobHandle(Future):
    ...
    _JOB_INITIAL_POLL_INTERVAL = 0.01
    _JOB_MAX_POLL_INTERVAL = 1

    _JOB_INITIAL_POLL_INTERVAL_CONF = 'livy.client.http.job.initial_poll_interval'
    _JOB_MAX_POLL_INTERVAL_CONF = 'livy.client.http.job.max_poll_interval'
    ...
    def __init__(self, conn, session_id, executor):
        ...
        self._job_initial_poll_interval = self._conn.config.getfloat('env', self._JOB_INITIAL_POLL_INTERVAL_CONF) \
            if self._conn.config.has_option('env', self._JOB_INITIAL_POLL_INTERVAL_CONF) else self._JOB_INITIAL_POLL_INTERVAL

        self._job_max_poll_interval_conf = self._conn.config.getfloat('env', self._JOB_MAX_POLL_INTERVAL_CONF) \
            if self._conn.config.has_option('env', self._JOB_MAX_POLL_INTERVAL_CONF) else self._JOB_MAX_POLL_INTERVAL
